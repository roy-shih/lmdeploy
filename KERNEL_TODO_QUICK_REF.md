...
| 3 | **KV Cache INT8 Quant** | `attention/decoding_*_u8.cu` (12个) | `cuda/kv_cache_quant.py` | 🔴 | ⭐⭐ | 1-2周 | ✅ |
| 4 | **KV Cache INT4 Quant** | `attention/decoding_*_u4.cu` (12个) | `cuda/kv_cache_quant.py` | 🔴 | ⭐⭐⭐ | 2-3周 | ✅ |
| 5 | **SM80 GEMM (A100)** | `gemm/kernel/sm80_*.cu` (3个) | `cuda/arch_gemm.py` | 🔴 | ⭐⭐⭐ | 2-3周 | ✅ |
